...
// Handle audio
const gamePoint = new Audio("zakky-bird-game/point.mp3");
const gameMusic = new Audio(
  "zakky-bird-game/audio_hero_Video-Game-Wizard_SIPML_Q-0245.mp3"
);
const gameOverSoundEffect = new Audio("zakky-bird-game/dieeffect.mp3");
